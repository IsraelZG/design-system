...
const PersonIcon = () => (_jsx("svg", { "aria-hidden": "true", viewBox: "0 0 24 24", fill: "currentColor", className: "w-[55%] h-[55%] opacity-60", children: _jsx("path", { d: "M12 12a5 5 0 1 0 0-10 5 5 0 0 0 0 10Zm0 2c-5.33 0-8 2.67-8 4v1h16v-1c0-1.33-2.67-4-8-4Z" }) }));
const Avatar = React.forwardRef(({ src, alt = '', fallback, size, ring, className, ...props }, ref) => {
    const [imgError, setImgError] = React.useState(false);
    const showImage = src && !imgError;
    return (_jsx("span", { ref: ref, role: "img", "aria-label": alt || undefined, className: cn(avatarVariants({ size, ring }), className), ...props, children: showImage ? (_jsx("img", { src: src, alt: alt, "aria-hidden": "true", className: "w-full h-full object-cover", onError: () => setImgError(true) })) : fallback ? (_jsx("span", { "aria-hidden": "true", children: fallback.slice(0, 2).toUpperCase() })) : (_jsx(PersonIcon, {})) }));
});
