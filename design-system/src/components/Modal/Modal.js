...
// ─── Component ─────────────────────────────────────────────────────────────
const Modal = ({ open, onClose, children, size = 'md', title, dismissible = true, className, }) => {
    ...
    return createPortal(_jsxs("div", { className: "fixed inset-0 z-[400] flex items-center justify-center p-4", "aria-modal": "true", children: [_jsx("div", { "aria-hidden": "true", className: cn('absolute inset-0 bg-[var(--ds-component-modal-scrim)]', 'transition-opacity duration-[200ms]', visible ? 'opacity-100' : 'opacity-0'), onClick: dismissible ? onClose : undefined }), _jsxs("div", { ref: panelRef, role: "dialog", "aria-modal": "true", "aria-labelledby": titleId, className: cn(panelVariants({ size, visible }), className), children: [(title || dismissible) && (_jsxs("div", { className: "flex items-start justify-between gap-4 mb-4", children: [title && (_jsx("h2", { id: "modal-title", className: "text-lg font-semibold leading-snug", children: title })), dismissible && (_jsx("button", { type: "button", "aria-label": "Close dialog", onClick: onClose, className: cn('shrink-0 rounded-lg p-1.5 -mr-1 -mt-1 opacity-60 hover:opacity-100', 'transition-opacity duration-[150ms]', 'focus-visible:outline-none', 'focus-visible:ring-[length:var(--ds-focus-ring-width)]', 'focus-visible:ring-[color:var(--ds-focus-ring-color)]', 'focus-visible:ring-offset-[length:var(--ds-focus-ring-offset)]'), children: _jsx("svg", { "aria-hidden": "true", width: "16", height: "16", viewBox: "0 0 16 16", fill: "none", children: _jsx("path", { d: "M2 2l12 12M14 2L2 14", stroke: "currentColor", strokeWidth: "1.75", strokeLinecap: "round" }) }) }))] })), children] })] }), document.body);
};
